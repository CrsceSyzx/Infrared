...
//    private DataCollectionThread mainThread = null;
//    Shell shell;
//
//    /**
//     *创建一个MainForm的实例.
...
//                    //					mThread.start();
//                    //                    mainThread = new DataForwardThread(new IpAddress(receiveIp),
//                    //                            kilometerMark);
//                    //                    mainThread = new DataCollectionThread(
//                    //                            "http://" + IPTxt.getText() + "/r/ioldetails.lr?port=" + PortTxt.getText());
//                    //                    mainThread.setCycleFinishedEventHandler(new TimerEventHandler() {
//                    //                        public void dataUpdate(Object sender, TimerEventArgs e) {
//                    //                            @SuppressWarnings("unchecked")
//                    //                            List<Integer> input = (List<Integer>) e.getTimerData();
//                    //                            display.syncExec(new TextAppender(ReciveTxt, "append", e.getTimerData()));
//                    //                            display.syncExec(new TextAppender(LengTxt, "set", input.get(0) * 256 + input.get(1)));
//                    //                        }
//                    //                    });
//                    mainThread.start();
//
...
//         */
//
//        public TextAppender(Text textbox, String mode, Object value) {
